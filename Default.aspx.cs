...
public partial class _Default : Page
{
    ...
    public void DownloadFileOPeration4GB(object sender, EventArgs e)
    {
        // **************************************************
        string strFileName =
            string.Format("OceanGames(4.83GB).zip");

        string strRootRelativePathName =
            string.Format("F:\\FileUploadDir\\OceanGames.zip", strFileName);

        // string strPathName =
        // Server.MapPath("C:\\Users\\Bala\\SPFX\\Uploads\\Temp\\Testfile.mp4");

        if (System.IO.File.Exists("F:\\FileUploadDir\\OceanGames.zip") == false)
        {
            return;
        }
        // **************************************************
        ...
        try
        {
            ...
            oStream =
                new System.IO.FileStream
                    (path: "F:\\FileUploadDir\\OceanGames.zip",
    ...
    public void DownloadFileOPeration(object sender, EventArgs e)
    {
        // **************************************************
        string strFileName =
            string.Format("MediaContent.mp4");

    //    string strRootRelativePathName =
           // string.Format("C:\\Users\\Bala\\SPFX\\Uploads\\Temp\\6410a160-d641-4809-b62e-f81e545e3808.zip", strFileName);

      // string strPathName =
           // Server.MapPath("C:\\Users\\Bala\\SPFX\\Uploads\\Temp\\Testfile.mp4");

        if (System.IO.File.Exists("F:\\FileUploadDir\\MediaContent.mp4") == false)
        {
            return;
        }
        // **************************************************
        ...
        try
        {
            ...
            oStream =
                new System.IO.FileStream
                    (path: "F:\\FileUploadDir\\MediaContent.mp4",
                    mode: System.IO.FileMode.Open,
                    share: System.IO.FileShare.Read,
                    access: System.IO.FileAccess.Read);
